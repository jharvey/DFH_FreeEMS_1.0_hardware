...
LIBS:power,/home/mythtv/freeEMS/hard/freeEMS_lib,device,conn,linear,regul,74xx,cmos4000,adc-dac,memory,xilinx,special,microcontrollers,dsp,microchip,analog_switches,motorola,texas,intel,audio,interface,digital-audio,philips,display,cypress,siliconi,contrib,valves,./RPM_input.cache
EELAYER 23  0
EELAYER END
$Descr A4 11700 8267
Sheet 1 1
...
F 10 "x" V 4830 3450 60  0001 C C
F 11 "other,more,stuff" V 4830 3450 60  0001 C C
	1    7850 2300
	-1   0    0    1   
$EndComp
...
U 1 1 4892E1BF
P 4450 3000
F 0 "#PWR?" H 4450 3000 30  0001 C C
...
U 1 1 4892E1BA
P 5150 1400
F 0 "#PWR?" H 5150 1400 30  0001 C C
...
F 10 "x" H 3100 2850 60  0001 C C
